...
def prediction():
	...
	predicted_class, data_for_display = test_predictor_class.predict(test_datapoint)
	...
	return flask.render_template('result_and_inference.html', tables = [data_for_display], output_class = prediction, sk_id_curr = sk_id_curr)
